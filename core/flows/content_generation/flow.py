...
from core.crews import TextGenerationCrew, ImageGenerationCrew
...
class ContentGenerationFlow(Flow[ContentGenerationState]):
    ...
    @listen(or_(writing_post, generate_image))
    def final_result(self):
        try:
            ...
            if self.state.image_generation_output:
                reshaped.append(
                    {
                        "image_url": self.state.image_generation_output.get("image_url"),
                        "enhanced_prompt": self.state.image_generation_output.get("enhanced_prompt"),
                    }
                )
